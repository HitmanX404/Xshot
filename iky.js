...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Xshot botz Verify Terlebih Dahulu Ya `
...
🔖 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created HitmanX`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `HitmanX`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/pery__nur/`)
             break
      case 'ikyygroup':
